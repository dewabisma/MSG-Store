...
export const updateOrderStatusToBePaid = (orderId, paymentResult) => async (
  dispatch,
  getState
) => {
  try {
...
export const updateDeliverStatusToBeDelivered = (order) => async (
  dispatch,
  getState
) => {
  try {
...
export const listUserOrders = () => async (dispatch, getState) => {
  try {
    ...
    dispatch({
      type: LIST_USER_ORDER_SUCCESS,
      payload: data,
    });
  } catch (error) {
    dispatch({
      type: LIST_USER_ORDER_FAIL,
      payload:
        error.response && error.response.data.message
          ? error.response.data.message
          : error.message,
...
export const listAllUsersOrders = () => async (dispatch, getState) => {
  try {
